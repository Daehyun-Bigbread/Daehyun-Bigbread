...
> 2026.02. ~ present.  
> AI, Cloud Architect | Google Cloud Platform (GCP) Tech Solutions Architect
>
...
## 👀 Interests
☁️ Cloud Native, AI Engineering & Ops (LLM, RAG)<br/>
  ...
  <details>
    ...
    <table>
        ...
        <tr>
          ...
          <td>앙상블 기반 추천 모델, 검색엔진 및 API 개발</td>
          <td>24.06 ~ 24.09</td>
          <td>kakao x Goorm - kakaotech Bootcamp</td>
        </tr>
        <tr>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>24.06.28 ~ 24.06.29</td>
        <td>24 HUFS Summer Hackathon</td>
      </tr>
      <tr>
